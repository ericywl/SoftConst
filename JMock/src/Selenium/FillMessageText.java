...
public class FillMessageText {
    private static String myUserName = "sudiptaonline";
    private static String myPassword = "thisisnotmypassword";

    public static void main(String[] args) throws InterruptedException {

        System.setProperty("webdriver.chrome.driver", "/Users/ericyap/Desktop/chromedriver");
